...

{
  ...
  "description": "You can now set up Call-to-Actions easily via our handy template. All you need is the index of the CTA you wish to trigger and the optional value or text you may want to send into Mediahawk. ",
  "containerContexts": [
    "WEB"
  ]
}
